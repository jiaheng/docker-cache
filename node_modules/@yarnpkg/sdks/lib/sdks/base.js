...
exports.BASE_SDKS = exports.generateFlowBinBaseWrapper = exports.generateSvelteLanguageServerBaseWrapper = exports.generateTypescriptBaseWrapper = exports.generateTypescriptLanguageServerBaseWrapper = exports.generateRelayCompilerBaseWrapper = exports.generatePrettierBaseWrapper = exports.generateEslintBaseWrapper = exports.generateAstroLanguageServerBaseWrapper = void 0;
const generateSdk_1 = require("../generateSdk");
const generateAstroLanguageServerBaseWrapper = async (pnpApi, target) => {
    const wrapper = new generateSdk_1.Wrapper(`@astrojs/language-server`, { pnpApi, target });
    await wrapper.writeDefaults();
    return wrapper;
};
exports.generateAstroLanguageServerBaseWrapper = generateAstroLanguageServerBaseWrapper;
...
const generatePrettierBaseWrapper = async (pnpApi, target) => {
    const wrapper = new generateSdk_1.Wrapper(`prettier`, { pnpApi, target, manifestOverrides: { exports: undefined } });
    await wrapper.writeDefaults();
    return wrapper;
};
exports.generatePrettierBaseWrapper = generatePrettierBaseWrapper;
const generateRelayCompilerBaseWrapper = async (pnpApi, target) => {
    const wrapper = new generateSdk_1.Wrapper(`relay-compiler`, { pnpApi, target });
    await wrapper.writeDefaults();
    return wrapper;
};
exports.generateRelayCompilerBaseWrapper = generateRelayCompilerBaseWrapper;
...
exports.BASE_SDKS = [
    [`@astrojs/language-server`, exports.generateAstroLanguageServerBaseWrapper],
    [`eslint`, exports.generateEslintBaseWrapper],
    [`prettier`, exports.generatePrettierBaseWrapper],
    [`relay-compiler`, exports.generateRelayCompilerBaseWrapper],
